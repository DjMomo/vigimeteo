...
<html>
	...
	<body>
		<div id="menu">
			<ul id="onglets">
				...
				<li><a href="index-departements-41-a-60.php"> Départements 41 à 60 </a></li>
				<li><a href="index-departements-61-a-80.php"> Départements 61 à 80 </a></li>
				<li class="active"><a href="index-departements-81-a-99.php"> Départements 81 à 99 </a></li>
			</ul>
		</div>
	...
	<?php
		...
		include ("inc/vigilance-departement-81-a-99.php");
		echo '</table><br />';
		echo 'Pour les départements 92, 93 et 94, rendez-vous dans l\'onglet "Départements 61 à 80". Ils sont considérés comme le département 75 (Paris).';
