...
<html>
	...
	<body>
		<div id="menu">
			<ul id="onglets">
				<li class="active"><a href="index-cote.php"> Côte départements </a></li>
	...
	<?php
		...
		echo '<table style="width: 30%; border-collapse: collapse; text-align: center;" border="1" bordercolor="#000">
				<tr>
					<td style="width: 15%; font-weight: bold; background: #CECECE;">La côte pour le département</td>
					<td style="width: 15%; font-weight: bold; background: #CECECE;">Est en vigilance</td>
				</tr>';
		// Vigilance Côtiers
		include ("inc/vigilance-cotes.php");
		echo '</table>';
